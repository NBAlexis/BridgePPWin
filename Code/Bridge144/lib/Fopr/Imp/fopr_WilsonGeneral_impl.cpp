...
//====================================================================
                                          ...
                                          const std::vector<int> bc)
  {
    ...
    //- additional boundary condition for each node:
...
#pragma omp master
    {
      int idir_x = 0;
      int Nv     = 2 * m_Nvc * m_Nd * m_Ny * m_Nz * m_Nt;
...
#pragma omp master
    {
      int idir_y = 1;
      int Nv     = 2 * m_Nvc * m_Nd * m_Nx * m_Nz * m_Nt;
...
#pragma omp master
    {
      int idir_z = 2;
      int Nv     = 2 * m_Nvc * m_Nd * m_Nx * m_Ny * m_Nt;
...
#pragma omp master
    {
      int idir_t = 3;
      // int Nv = 2 * m_Nvc * m_Nd * m_Nx * m_Ny * m_Nz;
      int Nv = m_Nvc * m_Nd * m_Nx * m_Ny * m_Nz;
