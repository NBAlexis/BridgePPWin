...
//====================================================================
  void Fopr_Wilson::mult_xp1_thread(
...
//====================================================================
  void Fopr_Wilson::mult_xp2_thread(
...
//====================================================================
  void Fopr_Wilson::mult_xpb_thread(
...
//====================================================================
  void Fopr_Wilson::mult_xm1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_xm2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_xmb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_yp1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_yp2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_ypb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_ym1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_ym2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_ymb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_zp1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_zp2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_zpb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_zm1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_zm2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_zmb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tp1_dirac_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tp2_dirac_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tpb_dirac_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tm1_dirac_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tm2_dirac_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tmb_dirac_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tp1_chiral_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tp2_chiral_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tpb_chiral_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tm1_chiral_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tm2_chiral_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::mult_tmb_chiral_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_Wilson::gm5_dirac_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
    int Nxy  = m_Nx * m_Ny;
...
//====================================================================
  void Fopr_Wilson::gm5_chiral_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
    int Nxy  = m_Nx * m_Ny;
