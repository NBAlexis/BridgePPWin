...
//====================================================================
  ...
  const std::string Fopr_CloverTerm_General::class_name = "Imp_BGQ::Fopr_CloverTerm_General";
...
//====================================================================
  void Fopr_CloverTerm_General::mult_csw_chiral(Field& v, const Field& w)
  {
    ...
    double kappa_cSW_s = m_kappa_s * m_cSW_s;
    double kappa_cSW_t = m_kappa_t * m_cSW_t;
