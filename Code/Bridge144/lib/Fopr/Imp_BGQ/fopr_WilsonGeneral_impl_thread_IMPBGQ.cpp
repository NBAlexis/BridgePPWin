...
//====================================================================
  void Fopr_WilsonGeneral::setup_thread()
  {
    ...
    if (m_Ntask_z * m_Ntask_t != m_Nthread) {
      vout.crucial(m_vl, "Error at %s: Nz(%d) * Nt(%d) \neq Nthread(%d)\n",
...
//====================================================================
  void Fopr_WilsonGeneral::mult_xp1_thread(
...
//====================================================================
  void Fopr_WilsonGeneral::mult_xp2_thread(
...
//====================================================================
  void Fopr_WilsonGeneral::mult_xpb_thread(
...
//====================================================================
  void Fopr_WilsonGeneral::mult_xm1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_xm2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_xmb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_yp1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_yp2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_ypb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_ym1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_ym2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_ymb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_zp1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_zp2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_zpb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_zm1_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_zm2_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_zmb_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tp1_dirac_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tp2_dirac_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tpb_dirac_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tm1_dirac_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tm2_dirac_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tmb_dirac_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tp1_chiral_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tp2_chiral_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tpb_chiral_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tm1_chiral_thread(
    int itask, double *vcp1, const double *v1)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tm2_chiral_thread(
    int itask, double *v2, const double *vcp2)
  {
    int Nvc2  = 2 * m_Nvc;
    int Nvcd  = m_Nvc * m_Nd;
...
//====================================================================
  void Fopr_WilsonGeneral::mult_tmb_chiral_thread(
    int itask, double *v2, const double *v1)
  {
    int Nvcd = m_Nvc * m_Nd;
