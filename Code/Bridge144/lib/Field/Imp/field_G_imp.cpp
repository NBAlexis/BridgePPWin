...
#include "field_G_imp_SU3.inc"
#elif defined USE_GROUP_SU2
#include "field_G_imp_SU2.inc"
#elif defined USE_GROUP_SU_N
#include "field_G_imp_SU_N.inc"
#endif
...
void Field_G::set_unit()
{
  ...
  int ns = nvol() * (i_thread + 1) / Nthread - is;
                    ...
                    const Field_G& U2, int ex2)
{
  ...
  int is = W.nvol() * i_thread / Nthread;
  int ns = W.nvol() * (i_thread + 1) / Nthread - is;
