/*!
        @file    $Id: test_HMC_Wilson_Leapfrog_Nf2.cpp #$
...
namespace Test_HMC_Wilson {
  ...
  namespace {
    const std::string filename_input = "test_HMC_Wilson_Leapfrog_Nf2.yaml";
  }
  ...
  int leapfrog_Nf2(void)
  {
    ...
    Parameters params_test      = params_all.lookup("Test_HMC_Wilson");
    ...
    unique_ptr<Force> force_fopr(new Force_F_Wilson_Nf2(str_gmset_type));
    ...
    actions.append(0, action_F);  // register actions at level0
