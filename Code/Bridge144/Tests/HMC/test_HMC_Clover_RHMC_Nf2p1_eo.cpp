/*!
        @file    $Id: test_HMC_Clover_RHMC_Nf2p1_eo.cpp #$
...
namespace Test_HMC_Clover {
  ...
  int RHMC_Nf2p1_eo(void)
  {
    ...
    unique_ptr<Fopr> fopr_smear_eo(Fopr::New("Smeared_eo", fopr_Nf2_eo, dr_smear));
    ...
    unique_ptr<Fopr> fopr_smear_eo_prec(Fopr::New("Smeared_eo", fopr_Nf2_eo_prec, dr_smear));
    ...
    unique_ptr<Solver> solver_eo_MD_prec(Solver::New(str_solver_MD_type, fopr_smear_eo_prec));
    solver_eo_MD_prec->set_parameters(params_solver_MD);
    unique_ptr<Fprop> fprop_eo_MD_prec(new Fprop_Standard_eo(solver_eo_MD_prec));

    unique_ptr<Solver> solver_eo_H_prec(Solver::New(str_solver_H_type, fopr_smear_eo_prec));
    solver_eo_H_prec->set_parameters(params_solver_H);
    unique_ptr<Fprop> fprop_eo_H_prec(new Fprop_Standard_eo(solver_eo_H_prec));


    unique_ptr<Action> action_F_Nf2_prec(
      new Action_F_Standard_eo(fopr_smear_prec, force_fopr_smear_prec,
                               fprop_eo_MD_prec, fprop_eo_H_prec));

    unique_ptr<Action> action_F_Nf2_d(
      new Action_F_Ratio_eo(fopr_smear_prec, force_fopr_smear_prec,
