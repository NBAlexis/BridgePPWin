/*!
        @file    $Id:: test_RandomNumbers_SFMT_GaussianField.cpp #$
...
namespace Test_RandomNumbers_SFMT {
  const std::string test_name = "RandomNumbers.SFMT.GaussianField";

  //- test-private parameters
  namespace {
    const std::string filename_input = "test_RandomNumbers_SFMT_GaussianField.yaml";
  }
  ...
  int gaussian_field(void)
  {
    ...
    // ####  object setup  ####
    unique_ptr<RandomNumbers> rand(new RandomNumbers_SFMT(iseed));
