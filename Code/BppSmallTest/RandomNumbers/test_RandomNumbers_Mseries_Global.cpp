...
namespace Test_RandomNumbers_Mseries {
  const std::string test_name = "RandomNumbers.Mseries.Global";

  //- test-private parameters
  namespace {
    const std::string filename_input = "test_RandomNumbers_Mseries_Global.yaml";
  }
  ...
  int test_global(void)
  {
    ...
    if (true) {
      ...
      rand->write_file("RNG_Mseries.state");
      ...
      rand->read_file("RNG_Mseries.state");
