...
//! FieldIO_Fortran class BAPI for file I/O of Field data in Fortran binary format.

/*!
   This class BAPI reads configuration from binary data file
   ...
   In this class BAPI, we assumed the data alignment as followes,\n
   ...
   FieldIO_Fortran class BAPI provides file I/O of Field data in Fortran binary
...
class BAPI FieldIO_Fortran : public FieldIO
{
 ...
 public:
  ...
  void read_file(std::vector<Field *>& vv, const std::string& filename) override;
  void write_file(std::vector<Field *>& vv, const std::string& filename) override;
};
#endif
