...
/*
    This class BAPI fixes the gauge of configuration to the Landau gauge.
...
class BAPI GaugeFixing_Landau : public GaugeFixing
{
 public:
 ...
 public:
  ...
  {
    return GaugeFixing::Factory::Register("Landau", create_object);
  }
#endif
};
#endif
