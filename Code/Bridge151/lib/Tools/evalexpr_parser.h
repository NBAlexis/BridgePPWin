...
#line 90 "evalexpr_parser.h"
   ...
   private:
    ...
    /// \param yytype       The token element_type.
    ...
    /// State stack element_type.
    typedef stack<state_type>      state_stack_type;
    /// Semantic value stack element_type.
    typedef stack<semantic_type>   semantic_stack_type;
    /// location stack element_type.
...
#if YYDEBUG
    /// A element_type to store symbol numbers and -1.
    ...
    /// \param yytype       The symbol element_type.
    /// \param yyvaluep     Its semantic value.
    /// \param yylocationp  Its location.
