...
yyerrlab1:
      ...
      for ( ; ; ) {
        ...
        {
          yyn += yyterror_;
            //yycheck_ is a constant table without "1", but yyterror_ = 1
            //how can you break out of this for?!....
    ...
    */
    if (yytoken != yyempty_)
    {
      ...
      if (!yy_pact_value_is_default_(yyn))
      {
        ...
        const int yyxend     = yychecklim < yyntokens_ ? yychecklim : yyntokens_;
