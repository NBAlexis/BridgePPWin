...
class BAPI Decompose_LU_Cmplx
{
 public:
  Decompose_LU_Cmplx(size_t N) : N(static_cast<int>(N)), N2(2 * static_cast<int>(N)), size(static_cast<int>(N) * N2), m_lu(size) {}
