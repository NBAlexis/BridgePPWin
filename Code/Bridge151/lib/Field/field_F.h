...
//! Wilson-element_type fermion field.

/*!
   This class BAPI defines 4-spinor (in the case of Ndim=4) fermion
   field, which is mainly used by Wilson-element_type fermions.
...
class BAPI Field_F : public Field
{
 ...
 public:
  ...
  // conversion from Field element_type
  ...
  void xI()
  {
    assert(field_element_type() == Element_type::COMPLEX);
...
//- function style
void BAPI mult_Field_Gn(Field_F& y, const int ex,
                   const Field_G& u, int ex1,
                   const Field_F& x, int ex2);

void BAPI mult_Field_Gd(Field_F& y, const int ex,
                   const Field_G& u, int ex1,
                   const Field_F& x, int ex2);

void BAPI multadd_Field_Gn(Field_F& y, const int ex,
                      const Field_G& u, int ex1,
                      const Field_F& x, int ex2,
                      const double a);

void BAPI multadd_Field_Gd(Field_F& y, const int ex,
                      const Field_G& u, int ex1,
                      const Field_F& x, int ex2,
                      const double a);

//! gamma matrix multiplication
void BAPI mult_GM(Field_F& y,
             const GammaMatrix& gm,
             const Field_F& x);

//! gamma matrix multiplication (i is multiplied)
void BAPI mult_iGM(Field_F& y,
              const GammaMatrix& gm,
              const Field_F& x);

//! projection with gamma matrix: (1 \pm gamma)/2
void BAPI mult_GMproj(Field_F& y,
                 const int pm, const GammaMatrix& gm,
                 const Field_F& x);

//! projection with gamma matrix: (1 \pm gamma)
void BAPI mult_GMproj2(Field_F& y,
                  const int pm, const GammaMatrix& gm,
                  const Field_F& x);
