...
/*!
    This class BAPI implements the Wilson_General fermion operator,
...
namespace Imp {
  class BAPI Fopr_WilsonGeneral : public Fopr
  {
   public:
   ...
   public:
    ...
    {
      bool init1 = Fopr::Factory_noarg::Register("WilsonGeneral/Imp", create_object);
      bool init2 = Fopr::Factory_string::Register("WilsonGeneral/Imp", create_object_with_repr);
