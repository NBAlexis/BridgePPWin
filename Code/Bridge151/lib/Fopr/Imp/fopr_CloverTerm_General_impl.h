...
#ifndef FOPR_CLOVERTERM_GENERAL_IMPL_IMP_INCLUDED
#define FOPR_CLOVERTERM_GENERAL_IMPL_IMP_INCLUDED
...
/*!
    This class BAPI implements the clover term for Clover general
...
namespace Imp {
  class BAPI Fopr_CloverTerm_General : public Fopr
  {
   public:
...
#endif /* FOPR_CLOVERTERM_GENERAL_IMPL_IMP_INCLUDED */
