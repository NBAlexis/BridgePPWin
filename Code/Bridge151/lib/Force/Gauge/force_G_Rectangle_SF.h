...
//! HMC force class BAPI for rectangular gauge action with the SF BC.
...
class BAPI Force_G_Rectangle_SF : public Force_G
{
 public:
 ...
 public:
  ...
  {
    return Force_G::Factory::Register("Force_G_Rectangle_SF", create_object);
  }
#endif
};
#endif
