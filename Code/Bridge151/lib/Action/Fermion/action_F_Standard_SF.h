...
/*!
    This class BAPI defines an action with SF BC used in HMC.
    <ul>
    <li>Generated by copying Action_F_Standard class BAPI.
    ...
    <li>The following properties are the same as those of the Action_F_Standard class BAPI.
    <ul>
...
class BAPI Action_F_Standard_SF : public Action
{
 public:
 ...
 public:
  ...
  Action_F_Standard_SF(unique_ptr<Fopr>& fopr, unique_ptr<Force>& fopr_force)
    : Action(), m_fopr(fopr.get()), m_fopr_force(fopr_force.get())
  {
    set_parameters();
  }
