/*!
        @file    solver_BiCGStab_DS_L_Cmplx.h
...
#ifndef SOLVER_BICGSTAB_DS_L_CMPLX_INCLUDED
#define SOLVER_BICGSTAB_DS_L_CMPLX_INCLUDED
...
/*!
    This class BAPI implements BiCGStab(DS_L) algorithm for nonhermitian matrix.
    The product of vectors is treated in complex.
    See T.Miyauchi et al, Trans.J.SIAM 11 (2) (2001) 49.
...
class BAPI Solver_BiCGStab_DS_L_Cmplx : public Solver
{
 public:
 ...
 public:
    ...
    : Solver(), m_fopr(fopr)
  {
    ...
    //- default value of m_Omega_tolerance = 0.60 for BiCGStab_DS_L
 ...
 public:
  ...
  {
    return Solver::Factory::Register("BiCGStab_DS_L_Cmplx", create_object);
  }
#endif
};
#endif
