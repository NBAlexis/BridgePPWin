/*!
        @file    solver_BiCGStab_IDS_L_Cmplx.h
...
/*!
    This class BAPI implements BiCGStab(IDS_L) algorithm for nonhermitian matrix.
...
class BAPI Solver_BiCGStab_IDS_L_Cmplx : public Solver
{
 public:
 ...
 public:
    ...
    : Solver(), m_fopr(fopr)
  {
    ...
    //- default value of m_Omega_tolerance = 0.60 for BiCGStab_IDS_L
 ...
 private:
  ...
  {
    return new Solver_BiCGStab_IDS_L_Cmplx(fopr);
  }

 public:
  static bool register_factory()
  {
    return Solver::Factory::Register("BiCGStab_IDS_L_Cmplx", create_object);
  }
#endif
};
#endif
