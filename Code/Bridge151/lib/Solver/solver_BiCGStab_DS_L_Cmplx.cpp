/*!
        @file    solver_BiCGStab_DS_L_Cmplx.cpp
...
namespace {
  bool init = Solver_BiCGStab_DS_L_Cmplx::register_factory();
}
#endif
...
//====================================================================
void Solver_BiCGStab_DS_L_Cmplx::set_parameters(const int Niter, const int Nrestart, const double Stop_cond, const bool use_init_guess)
{
  ThreadManager_OpenMP::assert_single_thread(class_name);
...
//====================================================================
void Solver_BiCGStab_DS_L_Cmplx::set_parameters_BiCGStab_series(const double Omega_tolerance)
{
  ThreadManager_OpenMP::assert_single_thread(class_name);
